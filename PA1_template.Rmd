...
```{r}
hist(steps_per_day, xlab="Steps Per Day", ylab = "Daily Occurances")
```
...
plot(names(steps_per_interval),steps_per_interval, type="l", xlab="Intervals (5 minutes)", ylab = "Steps per Interval")
```
&nbsp;
...
```{r}
hist(steps_per_day_interpolated, xlab="Steps Per Day", ylab = "Daily Occurances")
```
